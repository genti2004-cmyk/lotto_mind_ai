        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v51 Gesamtstabilisierung & Modernisierung',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v51 Gesamtstabilisierung'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v51 stabil: echte Daten zuerst, Zusatzdaten optional'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v51 Gesamtstabilisierung',
                    subtitle: 'Die App priorisiert jetzt stabile echte Lotto-Daten und behandelt Zusatzlotterien ehrlich als optionale Daten.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Lottozahlen und Superzahl sind Pflichtdaten und kommen stabil aus dem JSON-Archiv.'),
                  _ReleaseLine('Spiel 77 und SUPER 6 sind Zusatzdaten und werden nur angezeigt, wenn sie sicher verfügbar sind.'),
                  _ReleaseLine('Fehlende Zusatzdaten werden als „nicht verfügbar“ angezeigt und nicht künstlich ergänzt.'),
                  _ReleaseLine('Der Import erzwingt keine langen Zusatzdaten-Suchen mehr.'),
                  _ReleaseLine('Generator, Analyse und Tracking arbeiten nur mit echten gespeicherten Ziehungsdaten.'),
                  _ReleaseLine('Datenqualität zeigt klar, ob Zusatzlotterien vorhanden, teilweise verfügbar oder nicht verfügbar sind.'),
                  _ReleaseLine('Vorhandene Ziehungen bleiben erhalten, wenn keine neuen sicheren Daten gefunden werden.'),
                  _ReleaseLine('Tracking trennt echte Auswertung und historischen Rücktest weiterhin transparent.'),
                  _ReleaseLine('Keine Gewinnzusage: Alle Signale sind historische Auffälligkeiten, keine sichere Vorhersage.'),
                ],
              ),
            ),

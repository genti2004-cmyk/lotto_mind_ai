        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v40 Abstandsmuster – Signal-Tipps prüfen zusätzlich Streuung, Cluster und Lückenmuster',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v40 Abstandsmuster'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Bereichs- und Abstandsmuster im Signalmodell'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v40 verbessert?',
                    subtitle: 'Das Signalmodell berücksichtigt jetzt zusätzlich Abstandsmuster zwischen sortierten Tippzahlen.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Bereichsmuster aus v39 bleiben erhalten: 1–10, 11–20, 21–30, 31–40 und 41–49.'),
                  _ReleaseLine('Neu: Signal-Tipps prüfen zusätzlich die Abstände zwischen den sortierten Zahlen.'),
                  _ReleaseLine('Sehr enge 3er-Cluster werden sanft vermieden.'),
                  _ReleaseLine('Sehr gleichmäßige, künstlich wirkende Lückenmuster werden sanft abgewertet.'),
                  _ReleaseLine('Eine zu kleine Gesamtspanne im Tipp wird vermieden, damit Kombinationen natürlicher gestreut sind.'),
                  _ReleaseLine('Analyse zeigt einen Hinweisbereich Abstandsmuster.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Meine Tipps, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v40 bewertet historische Muster und Tipp-Streuung, aber gibt keine sichere Vorhersage.'),
                ],
              ),
            ),

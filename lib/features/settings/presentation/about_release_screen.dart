        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v54b Struktur: Home finalisiert',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v54b Struktur: Home finalisiert'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v54b stabil: Home-Struktur bereinigt'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v54b Struktur: Home finalisiert',
                    subtitle: 'Tracking Pro zeigt historische Simulationen jetzt seriöser und die Ergebnis-/Strategie-Karten kompakter.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Startseite liegt jetzt sauber unter features/home statt features/dashboard.'),
                  _ReleaseLine('Alte Dashboard-Struktur wurde entfernt, damit lib näher an der Zielarchitektur liegt.'),
                  _ReleaseLine('Navigation nutzt weiterhin die bestehende HomeScreen-Startseite.'),
                  _ReleaseLine('Keine Änderung an Import, Generator, Tipps, Tracking oder Auswertung.'),
                  _ReleaseLine('Die App bleibt fachlich auf dem stabilen Stand vor dem Struktur-Refactor.'),
                  _ReleaseLine('Nächster Struktur-Schritt: Tracking, Tips, Evaluation und Core weiter finalisieren.'),
                ],
              ),
            ),

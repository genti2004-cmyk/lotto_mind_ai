        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v46b Stabiler Performance-Stand – Analyse-Cache aktiv',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v46b Stabiler Performance-Stand'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v46 stabil wiederhergestellt; v47 nicht übernommen'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v46b Stabilitätsstatus',
                    subtitle: 'Dieser Stand bleibt bewusst auf dem stabilen v46-Release und übernimmt die schwere v47-Kandidatenbewertung nicht.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Analyse-Cache bleibt aktiv: Signalwerte werden nicht unnötig mehrfach neu berechnet.'),
                  _ReleaseLine('Import, Superzahl-Erkennung und 8-Wochen-Suche bleiben unverändert stabil.'),
                  _ReleaseLine('Generator, Meine Tipps, Tracking Pro und Auswertung bleiben auf dem geprüften v46-Stand.'),
                  _ReleaseLine('Die schwere v47-Kandidatenbewertung wurde wegen Performance-Risiko nicht übernommen.'),
                  _ReleaseLine('Ziel: stabiler Release-Stand mit guter Performance statt riskanter Zusatzberechnung.'),
                  _ReleaseLine('Wichtig: Auch v46b ist ein Analyse- und Assistenztool, keine sichere Gewinnvorhersage.'),
                ],
              ),
            ),

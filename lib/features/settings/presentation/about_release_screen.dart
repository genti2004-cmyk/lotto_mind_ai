        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v41 Strategie-Badge – gespeicherte Tipps zeigen die Strategie verständlicher an',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v41 Strategie-Badge'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Signalmodell + v41 bessere Tipp-Karten'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v41 verbessert?',
                    subtitle: 'Meine Tipps zeigt die verwendete Strategie jetzt verständlicher direkt auf der Tipp-Karte.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Tipp-Karten zeigen jetzt nicht mehr nur „Signal“, „Basis“ oder „Pro“.'),
                  _ReleaseLine('Stattdessen steht dort klarer „Strategie: Signal“, „Strategie: Basis“ usw.'),
                  _ReleaseLine('Das hilft neuen Nutzern, sofort zu verstehen, welche Methode den Tipp erzeugt hat.'),
                  _ReleaseLine('Die Änderung betrifft nur die Anzeige in „Meine Tipps“.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Generator, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v41 ist ein Verständlichkeits-Fix, keine neue Vorhersage- oder Berechnungslogik.'),
                ],
              ),
            ),

        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v38 Bereichsmuster – Zahlen 1–10 und 11–49 fließen in das Signalmodell ein',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v38 Bereichsmuster'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v38 Bereichsmuster im Signalmodell ergänzt'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v38 verbessert?',
                    subtitle: 'Das Signalmodell berücksichtigt jetzt zusätzlich Bereichsmuster bei kleinen und großen Zahlen.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Zahlen 1–10 werden als kleine Zahlengruppe analysiert.'),
                  _ReleaseLine('Zahlen 11–49 werden als große Zahlengruppe analysiert.'),
                  _ReleaseLine('Die App prüft, ob kleine Zahlen zuletzt eher unter- oder überrepräsentiert waren.'),
                  _ReleaseLine('Dieses Bereichsmuster fließt weich in den Hybrid-Score ein.'),
                  _ReleaseLine('Der Signal-Tipp kann dadurch ausgewogener zwischen kleinen und großen Zahlen wählen.'),
                  _ReleaseLine('Signal-Erklärungen nennen jetzt auffällige Bereichsmuster, wenn sie relevant sind.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Meine Tipps, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v38 bewertet historische Muster und ist keine sichere Vorhersage.'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  ...
                  _ReleaseLine('Signal-Tipp auf Bereichsmuster 1–10 / 11–49, gerade/ungerade und Wiederholer prüfen'),

        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v42 Strategie-Auswahl – Generator erklärt Basis, Analyse, Pro und System verständlicher',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v42 Strategie-Auswahl'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Signalmodell + v42 Generator-Erklärung'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v42 verbessert?',
                    subtitle: 'Der Generator erklärt die auswählbaren Strategien jetzt direkt im jeweiligen Bereich.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Im Generator wird jetzt pro Tab erklärt, wofür Basis, Analyse, Pro und System gedacht sind.'),
                  _ReleaseLine('Basis wird als schneller Einstieg ohne Expertenlogik erklärt.'),
                  _ReleaseLine('Analyse und Signal werden als Musteranalyse mit Häufigkeit, Rückstand, Intervall, Bereichs- und Abstandsmustern erklärt.'),
                  _ReleaseLine('Pro wird klarer als Expertenbereich mit Kandidaten, Simulation und mehr Details beschrieben.'),
                  _ReleaseLine('System wird als Bereich für mehrere Reihen und Systemscheine erklärt.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Tipp-Speicherung, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v42 ist ein Nutzerführungs-Fix, keine neue Vorhersage- oder Berechnungslogik.'),
                ],
              ),
            ),

        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v43 Kompakter Generator – Strategie-Erklärungen kürzer und übersichtlicher',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v43 Kompakter Generator'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Signalmodell + v43 Generator-Feinschliff'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v43 verbessert?',
                    subtitle: 'Der Generator erklärt die auswählbaren Strategien jetzt direkt im jeweiligen Bereich.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Die Strategie-Erklärung im Generator wurde gekürzt, damit der Bereich weniger überladen wirkt.'),
                  _ReleaseLine('Basis, Analyse, Pro und System zeigen weiterhin ihren Zweck, aber kompakter.'),
                  _ReleaseLine('Der Hinweis „Am besten für“ wurde verkürzt und nimmt weniger Platz ein.'),
                  _ReleaseLine('Lange Erklärungstexte wurden reduziert, ohne die Bedeutung der Strategien zu entfernen.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Tipp-Speicherung, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v43 ist ein UI-Feinschliff, keine neue Vorhersage- oder Berechnungslogik.'),
                ],
              ),
            ),

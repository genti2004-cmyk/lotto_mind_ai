        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v45 Meine Tipps klarer – Status und nächste Aktion verständlicher',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v45 Meine Tipps klarer'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Signalmodell + v45 Tipp-Status-Feinschliff'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v45 verbessert?',
                    subtitle: 'Der Generator erklärt die auswählbaren Strategien jetzt direkt im jeweiligen Bereich.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Meine Tipps zeigt den Status pro Tipp verständlicher: wartet, bereit zur Prüfung, geprüft oder Zielziehung offen.'),
                  _ReleaseLine('Jede Tipp-Karte nennt jetzt die nächste Aktion, zum Beispiel passende Ziehung wählen, Tipp prüfen oder Ergebnis ansehen.'),
                  _ReleaseLine('Die Trefferanzeige wurde klarer formuliert, ohne die Auswertungslogik zu verändern.'),
                  _ReleaseLine('Strategie und Zielziehung bleiben auf der Tipp-Karte direkt sichtbar.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Generator, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v45 ist ein UI-Feinschliff für Meine Tipps, keine neue Vorhersage- oder Berechnungslogik.'),
                ],
              ),
            ),

        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v53b Tracking Pro kompaktere Karten',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v53b Tracking Pro kompaktere Karten'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v53b stabil: Tracking Pro kompaktere Karten'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v53b Tracking Pro kompaktere Karten',
                    subtitle: 'Tracking Pro zeigt historische Simulationen jetzt seriöser und die Ergebnis-/Strategie-Karten kompakter.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Tracking Pro nennt Rücktests jetzt klarer historische Simulationen.'),
                  _ReleaseLine('ROI und rechnerischer Gewinn werden weniger wie echte Gewinnbilanz dargestellt.'),
                  _ReleaseLine('Meine Tipps bleibt der führende Bereich für echte Tipp-Auswertungen.'),
                  _ReleaseLine('Strategie-Vergleich wurde kompakter und verständlicher formuliert.'),
                  _ReleaseLine('Buttontexte wurden nutzerfreundlicher: Tipp speichern & verfolgen.'),
                  _ReleaseLine('Lange Simulationszeilen wurden gekürzt, damit Karten weniger überladen wirken.'),
                  _ReleaseLine('Keine Änderung an Berechnung, Import, Generator, Speicherung oder Auswertung.'),
                  _ReleaseLine('Keine Gewinnzusage: Rücktests bleiben historische Simulationen.'),
                ],
              ),
            ),

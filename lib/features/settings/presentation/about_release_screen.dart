        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v49 Datenqualität & Import-Transparenz',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v49 Datenqualität'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v49 stabiler Import mit Datenqualitätsanzeige'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v49 Verbesserungsstatus',
                    subtitle: 'Der Ziehungen-Bereich zeigt jetzt klarer, ob die Datenbasis aktuell und brauchbar ist.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Datenqualität-Karte im Ziehungen-Bereich ergänzt.'),
                  _ReleaseLine('Neueste Ziehung, Datenalter, Mittwoch/Samstag-Status und Importquelle sind sichtbar.'),
                  _ReleaseLine('Importquelle wird transparent als JSON-Archiv mit HTML-Fallback erklärt.'),
                  _ReleaseLine('Letzte Importmeldung bleibt sichtbar, damit Nutzer wissen, was passiert ist.'),
                  _ReleaseLine('Analyse-Cache bleibt aktiv: Signalwerte werden nicht unnötig mehrfach neu berechnet.'),
                  _ReleaseLine('Import, Superzahl-Erkennung und 8-Wochen-Suche bleiben auf dem stabilen v48c-Stand.'),
                  _ReleaseLine('Generator, Meine Tipps, Tracking Pro und Auswertung wurden nicht verändert.'),
                  _ReleaseLine('Wichtig: Datenqualität bedeutet Plausibilität der Datenbasis, keine Gewinnzusage.'),
                ],
              ),
            ),

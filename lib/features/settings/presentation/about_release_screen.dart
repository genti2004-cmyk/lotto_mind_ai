        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v36 Strategie-Lernbericht / Tracking Pro Vergleich, App-Store-Readiness und finale Freigabe-Checks',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v36 Strategie-Lernbericht'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v30 Release-Kandidat + v31 App-Store-Readiness + v32 Hinweise + v33 Onboarding + v34 Start-Assistent + v35 Strategiegewichtung + v36 Lernbericht'),
                ],
              ),
            ),

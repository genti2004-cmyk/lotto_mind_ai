        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v46 Performance & Analyse-Cache – Signalberechnung effizienter',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v46 Performance & Analyse-Cache'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v37 stabil + v40 Signalmodell + v46 Performance'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'Was wurde in v46 verbessert?',
                    subtitle: 'Der Generator erklärt die auswählbaren Strategien jetzt direkt im jeweiligen Bereich.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Analyse-Scores werden jetzt zwischengespeichert, solange sich die Ziehungsdaten nicht ändern.'),
                  _ReleaseLine('Generator und Analyse müssen Häufigkeit, Rückstand, Intervall, Bereichs- und Abstandsmuster dadurch weniger oft neu berechnen.'),
                  _ReleaseLine('Der Cache ist klein gehalten und wird automatisch erneuert, wenn neue Ziehungen importiert oder andere Ziehungen geladen werden.'),
                  _ReleaseLine('Ziel: schnellere Signal-Tipps und flüssigere Analyseansicht ohne Änderung der fachlichen Ergebnisse.'),
                  _ReleaseLine('Unverändert: Import, Superzahl-Erkennung, 8-Wochen-Suche, Generator-Speicherung, Tracking Pro und Auswertung.'),
                  _ReleaseLine('Wichtig: v46 verbessert Effizienz und Berechnungsfluss, nicht die Gewinnwahrscheinlichkeit.'),
                ],
              ),
            ),

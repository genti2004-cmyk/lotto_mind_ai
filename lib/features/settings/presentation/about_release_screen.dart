        ...
        child: ListView(
          ...
          children: [
            const SectionTitle(
              ...
              subtitle: 'v48 Import-Status & schneller 8-Wochen-Import',
            ),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  const _InfoRow(label: 'Release-Stufe', value: 'v48 Import-Status'),
                  const SizedBox(height: 10),
                  ...
                  const SizedBox(height: 10),
                  const _InfoRow(label: 'Stabilitätsstand', value: 'v47b Generator ok + Import verbessert'),
                ],
              ),
            ),
            ...
            const AppCard(
              child: Column(
                ...
                children: [
                  AppBlockHeader(
                    title: 'v48 Verbesserungsstatus',
                    subtitle: 'Der 8-Wochen-Import nutzt jetzt einen schnelleren Importpfad und zeigt den laufenden Status klarer an.',
                  ),
                  SizedBox(height: 14),
                  _ReleaseLine('Analyse-Cache bleibt aktiv: Signalwerte werden nicht unnötig mehrfach neu berechnet.'),
                  _ReleaseLine('Import, Superzahl-Erkennung und 8-Wochen-Suche bleiben stabil; der 8-Wochen-Import wurde beschleunigt.'),
                  _ReleaseLine('Während der Suche wird der Import-Button gesperrt und der Status klar angezeigt.'),
                  _ReleaseLine('Generator, Meine Tipps, Tracking Pro und Auswertung bleiben auf dem geprüften v46-Stand.'),
                  _ReleaseLine('Signal-Tipp nutzt jetzt maximal wenige Kandidaten und ein hartes Sicherheitslimit.'),
                  _ReleaseLine('Bei zu wenig Daten fällt die App automatisch auf den einfachen Signal-Tipp zurück.'),
                  _ReleaseLine('Die schwere v47-Kandidatenbewertung bleibt verworfen und ist nicht enthalten.'),
                  _ReleaseLine('Wichtig: Auch v47b ist ein Analyse- und Assistenztool, keine sichere Gewinnvorhersage.'),
                ],
              ),
            ),

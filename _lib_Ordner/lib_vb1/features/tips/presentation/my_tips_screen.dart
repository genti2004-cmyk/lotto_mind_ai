...
class _MyTipsScreenState extends State<MyTipsScreen> {
  ...
  List<LottoTip> _resolveTips(LottoAppState state) {
    ...
    return base.where((tip) {
      ...
      final targetText = _tipTargetLabel(tip).toLowerCase();
  ...
  String _buildPlainText(List<LottoTip> tips) {
    return tips.asMap().entries.map((entry) {
      ...
      final targetPart = ' | ${_tipTargetLabel(tip)}';
      return 'Tipp ${entry.key + 1}: ${tip.numbers.join(', ')}$superPart$targetPart';
    }).join('\n');
  }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _PhaseCProEvaluationPanel(
                    draw: draw,
                    normalTipCount: state.savedTipsForSelectedDraw.length,
                    results: state.tipEvaluationResults,
                    onCheckAllNormal: draw == null || state.savedTipsForSelectedDraw.isEmpty
                        ? null
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Text(
                      draw == null
                          ...
                          : 'Nur passende Tipps gegen ${_formatDate(draw!.drawDate)} prüfen.',
          ...
          Wrap(
            ...
            children: [
              ...
              _ProActionButton(
                ...
                label: 'Vollsystem / Intervall prüfen',
                onTap: onCheckSystem,
              ),
              _ProActionButton(
          ...
          if (latest == null)
            const Text(
              'Noch keine Auswertung vorhanden. Es werden nur Tipps geprüft, deren Zielziehung zum Datum passt.',
...
String _tipTargetLabel(LottoTip tip) {
  final typeLabel = tip.targetDrawType.label;
  final targetDate = tip.targetDrawDate;
  if (targetDate == null || tip.targetDrawType == DrawType.unknown) {
    return 'Zielziehung: noch nicht festgelegt';
  }
  return 'Zielziehung: $typeLabel ${_formatDate(targetDate)}';
}
